...
x <- read_excel("C:/Users/leekennedy/Documents/GitHub/SRM_Package/data/VITA12.xlsx", 
...
Units <- tolower(sub("_P_","/",(x$UNITS[1])))
...
max.pts <- 400 # Maximum points plotted
points <- 60   # How many points used to set control lines
...
The following is the most recent control chart (control lines calculated after omitting any outliers (shown in red)).
