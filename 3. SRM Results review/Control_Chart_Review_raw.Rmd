...
#x<- read.csv("C:/Users/lkennedy/Dropbox/SRM Results review/SRM_data.csv", as.is=TRUE, header=TRUE)
x<- read.csv("/Users/Study Old/Dropbox/3. SRM Results review/SRM_data.csv", as.is=TRUE, header=TRUE)
...
max.pts <- 70 # Maximum points plotted
